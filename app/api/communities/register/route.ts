...
export async function POST(req: NextRequest) {
  try {
    ...
    let freeTrialDays = 3 // default for regular members
    ...
    if (isLeader) {
      ...
      if (comm) {
        ...
        // Skalia VIP = 30 days, others use community config or default 3
    ...
    return NextResponse.json({
      ...
      communityId,
      communityName,
      communityCode: isLeader ? normalizedUsername.toUpperCase() : code,
      role: userRole,
      trialEndsAt,
      freeTrialDays,
    })
