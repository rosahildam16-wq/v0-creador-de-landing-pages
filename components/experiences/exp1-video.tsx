          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            >
              <div className="relative flex h-24 w-24 items-center justify-center">
                ...
                <div className="relative flex h-20 w-20 items-center justify-center rounded-full border border-primary/40 bg-black/80 shadow-[0_0_40px_rgba(0,143,17,0.2)] backdrop-blur-xl transition-all duration-300 group-hover:scale-110 group-hover:border-primary">
