            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`rounded-lg border bg-secondary/50 px-4 py-3.5 text-sm text-foreground placeholder:text-muted-foreground/50 outline-none transition-colors focus:border-primary/60 focus:bg-secondary ${
                    formErrors.nombre ? "border-destructive" : "border-border"
                  }`}
                />
                {formErrors.nombre && (
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`rounded-lg border bg-secondary/50 px-4 py-3.5 text-sm text-foreground placeholder:text-muted-foreground/50 outline-none transition-colors focus:border-primary/60 focus:bg-secondary ${
                    formErrors.correo ? "border-destructive" : "border-border"
                  }`}
                />
                {formErrors.correo && (
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`rounded-lg border bg-secondary/50 px-4 py-3.5 text-sm text-foreground placeholder:text-muted-foreground/50 outline-none transition-colors focus:border-primary/60 focus:bg-secondary ${
                    formErrors.whatsapp ? "border-destructive" : "border-border"
                  }`}
                />
                {formErrors.whatsapp && (
