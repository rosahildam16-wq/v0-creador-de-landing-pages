...
export function LoginScreen({ onContinue }: Props) {
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center bg-black px-6">
      {/* TikTok top bar */}
      ...
      <div className="flex w-full max-w-sm flex-1 flex-col items-center justify-center">
        ...
        <div className="mb-4 flex items-center gap-3">
          ...
          />
          <span className="text-[28px] font-bold text-white tracking-tight">TikTok</span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          <div className="mb-3">
            ...
            <input
              ...
              className="w-full rounded-sm border-0 bg-neutral-900 px-4 py-3.5 text-[15px] text-white placeholder:text-neutral-600 outline-none focus:ring-1 focus:ring-neutral-700"
              required
            />
          </div>
          ...
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full rounded-sm border-0 bg-neutral-900 px-4 py-3.5 pr-12 text-[15px] text-white placeholder:text-neutral-600 outline-none focus:ring-1 focus:ring-neutral-700"
              required
            />
            <button
              type="button"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full rounded-sm py-3.5 text-[15px] font-semibold text-white transition-colors disabled:opacity-50"
        ...
        <div className="my-5 flex w-full max-w-sm items-center gap-3">
          ...
          <span className="text-[12px] text-neutral-600">o</span>
          <div className="h-px flex-1 bg-neutral-800" />
        </div>

        {/* Social login options (decorative) */}
        <div className="flex w-full max-w-sm flex-col gap-2.5">
          <div className="flex items-center gap-3 rounded-sm border border-neutral-800 px-4 py-3">
            ...
            <span className="text-[13px] text-white">Continuar con Google</span>
          </div>
          <div className="flex items-center gap-3 rounded-sm border border-neutral-800 px-4 py-3">
            ...
            <span className="text-[13px] text-white">Continuar con Apple</span>
          </div>
        </div>
      </div>
