  ...
  if (isEmbed) {
    ...
    return (
      <div className="relative flex min-h-dvh flex-col items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative aspect-[9/16] w-full max-w-md overflow-hidden bg-black shadow-[0_0_80px_rgba(37,244,238,0.1)] border-x border-white/5">
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/80 backdrop-blur-xl px-10 text-center animate-in fade-in zoom-in duration-700">
              ...
              <div className="flex w-full flex-col gap-4">
                <button type="button" onClick={onContinue}
                  className="group relative flex w-full items-center justify-between overflow-hidden rounded-2xl bg-primary px-6 py-5 text-lg font-black italic text-black shadow-[0_20px_40px_rgba(37,244,238,0.2)] transition-all hover:scale-[1.03] active:scale-95">
