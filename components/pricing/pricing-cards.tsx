      ...
      <div className="grid gap-6 md:grid-cols-3">
        {PLANS.map((plan) => {
          ...
          return (
            <div
              key={plan.id}
              className={`relative flex flex-col rounded-2xl border backdrop-blur-xl transition-all duration-500 hover:scale-[1.02] ${
                isPopular
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-8">
                ...
                <button
                  ...
                  className={`relative w-full rounded-xl px-6 py-3.5 text-sm font-semibold text-white transition-all duration-300 disabled:opacity-50 ${
                    isPopular
