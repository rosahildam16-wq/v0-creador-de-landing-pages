...
export const EMBUDOS: Embudo[] = [
  {
    ...
    etapas: [
      ...
      { id: 8, label: "Video de Decisión", icon: "Video", description: "Video de cierre de objeciones" },
      { id: 9, label: "Pagina de Venta", icon: "ShoppingCart", description: "Oferta final" },
    ],
  },
  {
...
Mira cómo funciona aquí:`,
  ...
  {
    id: "uh-may",
    nombre: "Boutique Living Uh May",
    descripcion: "Landing inmobiliaria premium — Coleccion privada de 18 lotes en Camino Blanco, Uh May, Tulum",
    estado: "activo",
    tipo: "landing",
    fecha_creacion: "2026-03-05",
    color: "hsl(150 35% 25%)",
    ghl: { enabled: false, tag: "mf_uh_may" },
    etapas: [
      { id: 1, label: "Hero — Territorio", icon: "MapPin", description: "Titular inmersivo con parallax y CTAs" },
      { id: 2, label: "Concepto Editorial", icon: "Award", description: "Baja densidad, corredor cultural, libertad creativa" },
      { id: 3, label: "Estructura de Inversion", icon: "ShoppingCart", description: "Timeline de precios por fases (2000–3250 MXN/m²)" },
      { id: 4, label: "Contexto Riviera Maya", icon: "MapPin", description: "Expansion regional y mapa abstracto" },
      { id: 5, label: "Autoridad — Alejandro ML", icon: "Users", description: "Credenciales y cita editorial" },
      { id: 6, label: "Certeza Juridica", icon: "Shield", description: "Propiedad privada, escrituracion, fideicomiso" },
      { id: 7, label: "Diagnostico de Inversion", icon: "MessageSquare", description: "3 preguntas tipo concierge + agendamiento" },
    ],
  },
]
