...
export const EMBUDOS: Embudo[] = [
  ...
  },
  {
    ...
    descripcion: "Landing page de captacion para la Masterclass: Crea tu Esclavo Digital en 24h",
    estado: "activo",
    tipo: "landing",
    ...
    etapas: [
      { id: 1, label: "Hero + Impacto", icon: "Play", description: "Pantalla completa con typing effect" },
      { id: 2, label: "Problema", icon: "AlertTriangle", description: "Seccion de dolor y problema" },
      { id: 3, label: "Concepto IA", icon: "Bot", description: "Que es un esclavo digital" },
      { id: 4, label: "Aprendizaje", icon: "Brain", description: "Lo que aprenderas en la masterclass" },
      { id: 5, label: "Demo + Autoridad", icon: "Monitor", description: "Demostracion y prueba social" },
